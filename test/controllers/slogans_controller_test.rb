...
class SlogansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slogan" do
    assert_difference('Slogan.count') do
      post slogans_url, params: { slogan: { content: @slogan.content, email: @slogan.email, first_name: @slogan.first_name, last_name: @slogan.last_name } }, as: :json
    end
  ...
  test "should update slogan" do
    patch slogan_url(@slogan), params: { slogan: { content: @slogan.content, email: @slogan.email, first_name: @slogan.first_name, last_name: @slogan.last_name } }, as: :json
    assert_response 200
  end
